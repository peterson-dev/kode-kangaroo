"""
Django settings for kodekangaroo project.
...
SECRET_KEY = 'qldzl5hcl66sc#x!nact1ql0^7xy9)b0s(8x&=%66a4s01rrg('
...
ROOT_URLCONF = 'kodekangaroo.urls'
...
WSGI_APPLICATION = 'kodekangaroo.wsgi.application'
